...
class EarningsContextTests(unittest.TestCase):
    def test_context_returns_three_days_from_the_server_date_without_duplicates(self) -> None:
        rows = [
        ...
        self.assertEqual(context["server_date"], "2026-08-05")
    ...
    def test_local_context_export_uses_the_same_candidate_source(self) -> None:
        candidates = [{"ticker": "AMD", "company_name": "AMD", "calendar_date": "2026-08-05", "announcement_time": "bmo"}]
