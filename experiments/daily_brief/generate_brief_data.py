...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--use-llm", action="store_true", help="Call DashScope/Bailian model to fill model_interpretation.")
    parser.add_argument("--llm-model", default="qwen3.7-plus", help="DashScope model name.")
    parser.add_argument("--llm-timeout", type=int, default=60, help="DashScope request timeout seconds.")
    parser.add_argument("--llm-max-tokens", type=int, default=1500, help="DashScope max output tokens.")
